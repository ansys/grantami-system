...
html_short_title = html_title = "PyGranta System"
html_favicon = ansys_favicon

cname = os.getenv("DOCUMENTATION_CNAME", "system.grantami.docs.pyansys.com")
"""The canonical name of the webpage hosting the documentation."""

# specify the location of your github repo
html_theme_options = {
    "github_url": "https://github.com/ansys/grantami-system",
...
if switcher_version != "dev":
    linkcheck_ignore.append(f"https://github.com/ansys/grantami-system/releases/tag/v{__version__}")
